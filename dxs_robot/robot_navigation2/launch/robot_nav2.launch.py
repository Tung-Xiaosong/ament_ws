...
def generate_launch_description():
    ...
    bringup_cmd_group = GroupAction([
        ...
        Node(
            condition=IfCondition(use_composition), #如果 use_composition 为真（true），则节点将会被启动。
            name='nav2_container',
        ...
        IncludeLaunchDescription(
            PythonLaunchDescriptionSource(os.path.join(robot_description_dir, 'load_robot_model_into_gazebo.launch.py')),
